              ...
              <div class="col-sm-12">
                <div class="text-center mb-4">
                  <b-button variant="danger">
                    ...
                    <b-badge variant="light" class="ml-2"> {{globalData.todayCases | numeralFormat}} </b-badge>
                    </h4>
                  </b-button>
                </div>
              </div>
              ...
              <div class="col-sm-6">
                <b-card text-variant="danger" header="Death" class="text-center rel">
                  <b-card-text>
                    ...
                    <small>with {{globalData.todayDeaths | numeralFormat}} death today</small>
              ...
              <div class="col-sm-6">
                <b-card text-variant="secondary" header="Active cases" class="rel text-center">
                  <b-card-text>
                    ...
                    <small>with {{globalData.critical | numeralFormat}} critical patient</small>
...
export default {
  ...
  methods: {
    ...
    renderChartData() {
      this.isLoading = true;
      (this.chartData = []),
        apiServiceCovid.getCountryDetails(this.countryCodeSelected)
          .then(data => {
    ...
    renderDataTrendDaily() {
      ...
      (this.chartData = []),
        apiServiceCovid
          .getGlobalTrend(this.countryCodeSelected)
          .then(data => {
